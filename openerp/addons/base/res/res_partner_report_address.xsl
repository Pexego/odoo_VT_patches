...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
    <xsl:variable name="initial_bottom_pos">21.6</xsl:variable>
    <xsl:variable name="initial_left_pos">0.9</xsl:variable>
    <xsl:variable name="height_increment">6.8</xsl:variable>
    <xsl:variable name="width_increment">9.7</xsl:variable>
    <xsl:variable name="frame_height">6.8cm</xsl:variable>
    <xsl:variable name="frame_width">9.7cm</xsl:variable>
    ...
    <xsl:template match="addresses">
        <document>
            <template leftMargin="0.0cm" rightMargin="0.0cm" topMargin="0.0cm"
                            bottomMargin="0.0cm" title="Address list" author="Generated by OpenERP">
                <pageTemplate id="all">
                    <pageGraphics/>
